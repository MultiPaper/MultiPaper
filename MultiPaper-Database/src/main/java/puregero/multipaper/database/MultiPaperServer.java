...
import puregero.multipaper.databasemessagingprotocol.MessageBootstrap;
import puregero.multipaper.databasemessagingprotocol.messages.databasebound.DatabaseBoundMessage;
import puregero.multipaper.databasemessagingprotocol.messages.databasebound.DatabaseBoundProtocol;
import puregero.multipaper.databasemessagingprotocol.messages.serverbound.ServerBoundMessage;
import puregero.multipaper.databasemessagingprotocol.messages.serverbound.ServerBoundProtocol;
import puregero.multipaper.database.proxy.ProxyServer;
import puregero.multipaper.database.util.LogToFile;
...
public class MultiPaperServer extends MessageBootstrap<DatabaseBoundMessage, ServerBoundMessage> {
    ...
    public MultiPaperServer(String address, int port) {
        super(new DatabaseBoundProtocol(), new ServerBoundProtocol(), channel -> channel.pipeline().addLast(new ServerConnection(channel)));
