...
import puregero.multipaper.databasemessagingprotocol.messages.databasebound.*;
import puregero.multipaper.databasemessagingprotocol.messages.serverbound.ServerBoundMessage;
import puregero.multipaper.databasemessagingprotocol.messages.serverbound.SetSecretMessage;
import puregero.multipaper.databasemessagingprotocol.messages.serverbound.ShutdownMessage;
import puregero.multipaper.database.handlers.*;
...
public class ServerConnection extends DatabaseBoundMessageHandler {
    ...
    public void send(ServerBoundMessage message, Consumer<DatabaseBoundMessage> callback) {
        send(setCallback(message, callback));
    }

    public void sendReply(ServerBoundMessage message, DatabaseBoundMessage inReplyTo) {
