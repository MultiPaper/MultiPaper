...
public class ExtendedByteBuf extends ByteBuf {
    ...
    public RegionKey readRegionKey() {
        return new RegionKey(readString(), readInt(), readInt());
    }

    public ExtendedByteBuf writeRegionKey(RegionKey regionKey) {
        this.writeString(regionKey.world());
        this.writeInt(regionKey.x());
        this.writeInt(regionKey.z());
        return this;
    }
